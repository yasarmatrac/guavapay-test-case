...
import com.guavapay.authorization.deserializer.NumberMixin;
import com.guavapay.authorization.deserializer.OAuth2TokenTypeMixin;
import com.guavapay.authorization.domain.Authorization;
import com.guavapay.authorization.repository.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public JpaOAuth2AuthorizationService(AuthorizationRepository authorizationRepository, RegisteredClientRepository registeredClientRepository) {
        ...
        this.objectMapper.addMixIn(OAuth2TokenType.class, OAuth2TokenTypeMixin.class);
        this.objectMapper.addMixIn(Long.class, NumberMixin.class);
    }
